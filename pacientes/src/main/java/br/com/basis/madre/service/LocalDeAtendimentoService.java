...
/**
 * Service Implementation for managing {@link LocalDeAtendimento}.
 */
...
public class LocalDeAtendimentoService {
    ...
    public LocalDeAtendimentoDTO save(LocalDeAtendimentoDTO localDeAtendimentoDTO) {
        ...
        LocalDeAtendimento localDeAtendimento = localDeAtendimentoMapper.toEntity(localDeAtendimentoDTO);
