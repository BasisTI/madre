package br.com.basis.madre.pacientes.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("pacientes");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("pacientes");
        ...
        config.getMapConfigs().put("br.com.basis.madre.pacientes.domain.*", initializeDomainMapConfig(jHipsterProperties));
