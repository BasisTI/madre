...
/**
 * Service Implementation for managing {@link PlanoDeSaude}.
 */
...
public class PlanoDeSaudeService {
    ...
    public Page<PlanoDeSaudeDTO> findAll(Pageable pageable) {
        log.debug("Request to get all PlanoDeSaudes");
        return planoDeSaudeRepository.findAll(pageable)
