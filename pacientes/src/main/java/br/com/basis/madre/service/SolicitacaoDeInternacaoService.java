...
/**
 * Service Implementation for managing SolicitacaoDeInternacao.
 */
@Service
@Transactional
public class SolicitacaoDeInternacaoService {
    ...
    public SolicitacaoDeInternacaoService(SolicitacaoDeInternacaoRepository solicitacaoDeInternacaoRepository, SolicitacaoDeInternacaoMapper solicitacaoDeInternacaoMapper, SolicitacaoDeInternacaoSearchRepository solicitacaoDeInternacaoSearchRepository) {
        this.solicitacaoDeInternacaoRepository = solicitacaoDeInternacaoRepository;
        this.solicitacaoDeInternacaoMapper = solicitacaoDeInternacaoMapper;
        this.solicitacaoDeInternacaoSearchRepository = solicitacaoDeInternacaoSearchRepository;
    }
    ...
    public SolicitacaoDeInternacaoDTO save(SolicitacaoDeInternacaoDTO solicitacaoDeInternacaoDTO) {
        ...
        SolicitacaoDeInternacao solicitacaoDeInternacao = solicitacaoDeInternacaoMapper.toEntity(solicitacaoDeInternacaoDTO);
        solicitacaoDeInternacao = solicitacaoDeInternacaoRepository.save(solicitacaoDeInternacao);
        SolicitacaoDeInternacaoDTO result = solicitacaoDeInternacaoMapper.toDto(solicitacaoDeInternacao);
