...
/**
 * REST controller for managing {@link br.com.basis.madre.domain.Internacao}.
 */
...
public class InternacaoResource {
    ...
    private static final String ENTITY_NAME = "pacientesInternacao";
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new internacaoDTO, or with status {@code 400 (Bad Request)} if the internacao has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/internacaos")
    public ResponseEntity<InternacaoDTO> createInternacao(@Valid @RequestBody InternacaoDTO internacaoDTO) throws URISyntaxException {
        log.debug("REST request to save Internacao : {}", internacaoDTO);
        if (internacaoDTO.getId() != null) {
            throw new BadRequestAlertException("A new internacao cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated internacaoDTO,
     * or with status {@code 400 (Bad Request)} if the internacaoDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the internacaoDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/internacaos")
    public ResponseEntity<InternacaoDTO> updateInternacao(@Valid @RequestBody InternacaoDTO internacaoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, internacaoDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of internacaos in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the internacaoDTO, or with status {@code 404 (Not Found)}.
     */
    ...
    public ResponseEntity<List<InternacaoDTO>> searchInternacaos(@RequestParam String query, Pageable pageable) {
