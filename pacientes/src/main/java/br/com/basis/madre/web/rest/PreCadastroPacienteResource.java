...
public class PreCadastroPacienteResource {
    ...
    public ResponseEntity<List<PreCadastroPacienteDTO>> getAllPreCadastroPacientes(Pageable pageable) {
        log.debug("REST request to get a page of PreCadastroPacientes");
        Page<PreCadastroPacienteDTO> page = preCadastroPacienteService.findAll(pageable);
