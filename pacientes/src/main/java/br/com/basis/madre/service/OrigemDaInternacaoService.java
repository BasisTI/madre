...
/**
 * Service Implementation for managing {@link OrigemDaInternacao}.
 */
...
public class OrigemDaInternacaoService {
    ...
    public OrigemDaInternacaoDTO save(OrigemDaInternacaoDTO origemDaInternacaoDTO) {
        ...
        OrigemDaInternacao origemDaInternacao = origemDaInternacaoMapper.toEntity(origemDaInternacaoDTO);
    ...
    public Page<OrigemDaInternacaoDTO> findAll(Pageable pageable) {
        log.debug("Request to get all OrigemDaInternacaos");
        return origemDaInternacaoRepository.findAll(pageable)
