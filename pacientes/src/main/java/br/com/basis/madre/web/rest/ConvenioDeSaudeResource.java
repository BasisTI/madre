...
/**
 * REST controller for managing {@link br.com.basis.madre.domain.ConvenioDeSaude}.
 */
...
public class ConvenioDeSaudeResource {
    ...
    private static final String ENTITY_NAME = "pacientesConvenioDeSaude";
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new convenioDeSaudeDTO, or with status {@code 400 (Bad Request)} if the convenioDeSaude has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/convenio-de-saudes")
    public ResponseEntity<ConvenioDeSaudeDTO> createConvenioDeSaude(@Valid @RequestBody ConvenioDeSaudeDTO convenioDeSaudeDTO) throws URISyntaxException {
        log.debug("REST request to save ConvenioDeSaude : {}", convenioDeSaudeDTO);
        if (convenioDeSaudeDTO.getId() != null) {
            throw new BadRequestAlertException("A new convenioDeSaude cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated convenioDeSaudeDTO,
     * or with status {@code 400 (Bad Request)} if the convenioDeSaudeDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the convenioDeSaudeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/convenio-de-saudes")
    public ResponseEntity<ConvenioDeSaudeDTO> updateConvenioDeSaude(@Valid @RequestBody ConvenioDeSaudeDTO convenioDeSaudeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, convenioDeSaudeDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of convenioDeSaudes in body.
     */
    @GetMapping("/convenio-de-saudes")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the convenioDeSaudeDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/convenio-de-saudes/{id}")
     ...
     */
    @DeleteMapping("/convenio-de-saudes/{id}")
    ...
    /**
     * {@code SEARCH  /_search/convenio-de-saudes?query=:query} : search for the convenioDeSaude corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search/convenio-de-saudes")
    public ResponseEntity<List<ConvenioDeSaudeDTO>> searchConvenioDeSaudes(@RequestParam String query, Pageable pageable) {
