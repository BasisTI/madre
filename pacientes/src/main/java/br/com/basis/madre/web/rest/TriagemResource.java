...
import br.com.basis.madre.web.rest.util.HeaderUtil;
import br.com.basis.madre.web.rest.util.PaginationUtil;
...
public class TriagemResource {
    ...
    public ResponseEntity<TriagemDTO> updateTriagem(@Valid @RequestBody TriagemDTO triagemDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, triagemDTO.getId().toString()))
            .body(result);
    }
