...
/**
 * REST controller for managing {@link br.com.basis.madre.domain.PlanoDeSaude}.
 */
...
public class PlanoDeSaudeResource {
    ...
    private static final String ENTITY_NAME = "pacientesPlanoDeSaude";
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new planoDeSaudeDTO, or with status {@code 400 (Bad Request)} if the planoDeSaude has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/plano-de-saudes")
    public ResponseEntity<PlanoDeSaudeDTO> createPlanoDeSaude(@Valid @RequestBody PlanoDeSaudeDTO planoDeSaudeDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated planoDeSaudeDTO,
     * or with status {@code 400 (Bad Request)} if the planoDeSaudeDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the planoDeSaudeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/plano-de-saudes")
    public ResponseEntity<PlanoDeSaudeDTO> updatePlanoDeSaude(@Valid @RequestBody PlanoDeSaudeDTO planoDeSaudeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, planoDeSaudeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<PlanoDeSaudeDTO>> getAllPlanoDeSaudes(Pageable pageable) {
        log.debug("REST request to get a page of PlanoDeSaudes");
        Page<PlanoDeSaudeDTO> page = planoDeSaudeService.findAll(pageable);
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the planoDeSaudeDTO, or with status {@code 404 (Not Found)}.
     */
    ...
    /**
     * {@code SEARCH  /_search/plano-de-saudes?query=:query} : search for the planoDeSaude corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search/plano-de-saudes")
    public ResponseEntity<List<PlanoDeSaudeDTO>> searchPlanoDeSaudes(@RequestParam String query, Pageable pageable) {
