 ...
 */
@Mapper(componentModel = "spring", uses = {EspecialidadeMapper.class, CRMMapper.class, HospitalMapper.class, OrigemDaInternacaoMapper.class, ConvenioDeSaudeMapper.class, PlanoDeSaudeMapper.class, ProcedimentoMapper.class, ProcedenciaMapper.class, ModalidadeAssistencialMapper.class, LocalDeAtendimentoMapper.class})
