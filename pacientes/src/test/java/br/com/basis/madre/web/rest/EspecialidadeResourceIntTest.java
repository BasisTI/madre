...
public class EspecialidadeResourceIntTest {
    ...
    public void searchEspecialidade() throws Exception {
        // Initialize the database
        especialidadeRepository.saveAndFlush(especialidade);
        when(mockEspecialidadeSearchRepository.search(queryStringQuery("id:" + especialidade.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(especialidade), PageRequest.of(0, 1), 1));
