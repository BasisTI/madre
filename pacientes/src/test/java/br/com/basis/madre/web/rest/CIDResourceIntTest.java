...
/**
 * Test class for the CIDResource REST controller.
 *
 * @see CIDResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = PacientesApp.class)
public class CIDResourceIntTest {
    ...
    public void searchCID() throws Exception {
        // Initialize the database
        cIDRepository.saveAndFlush(cID);
        when(mockCIDSearchRepository.search(queryStringQuery("id:" + cID.getId()), PageRequest.of(0, 20)))
