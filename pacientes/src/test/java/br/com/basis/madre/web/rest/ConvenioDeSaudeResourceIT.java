...
public class ConvenioDeSaudeResourceIT {
    ...
    public void setup() {
        ...
        final ConvenioDeSaudeResource convenioDeSaudeResource = new ConvenioDeSaudeResource(convenioDeSaudeService);
    ...
    public void createConvenioDeSaude() throws Exception {
        ...
        ConvenioDeSaude testConvenioDeSaude = convenioDeSaudeList.get(convenioDeSaudeList.size() - 1);
    ...
    public void getConvenioDeSaude() throws Exception {
        ...
        restConvenioDeSaudeMockMvc.perform(get("/api/convenio-de-saudes/{id}", convenioDeSaude.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void updateConvenioDeSaude() throws Exception {
        ...
        ConvenioDeSaude updatedConvenioDeSaude = convenioDeSaudeRepository.findById(convenioDeSaude.getId()).get();
    ...
    public void deleteConvenioDeSaude() throws Exception {
        ...
        restConvenioDeSaudeMockMvc.perform(delete("/api/convenio-de-saudes/{id}", convenioDeSaude.getId())
    ...
    public void searchConvenioDeSaude() throws Exception {
        // Initialize the database
        convenioDeSaudeRepository.saveAndFlush(convenioDeSaude);
        when(mockConvenioDeSaudeSearchRepository.search(queryStringQuery("id:" + convenioDeSaude.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(convenioDeSaude), PageRequest.of(0, 1), 1));
        // Search the convenioDeSaude
        restConvenioDeSaudeMockMvc.perform(get("/api/_search/convenio-de-saudes?query=id:" + convenioDeSaude.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(convenioDeSaude.getId().intValue())))
            .andExpect(jsonPath("$.[*].nome").value(hasItem(DEFAULT_NOME)));
