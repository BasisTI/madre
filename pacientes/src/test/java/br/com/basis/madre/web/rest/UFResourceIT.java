...
public class UFResourceIT {
     ...
     *
     * @see br.com.basis.madre.repository.search.UFSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    public void checkUnidadeFederativaIsRequired() throws Exception {
        int databaseSizeBeforeTest = uFRepository.findAll().size();
        // set the field null
        uF.setUnidadeFederativa(null);
