...
/**
 * REST controller for managing {@link br.com.basis.madre.farmacia.domain.Unidade}.
 */
@RestController
@RequestMapping("/api")
public class UnidadeResource {
    ...
    private static final String ENTITY_NAME = "farmaciaUnidade";
    ...
    public ResponseEntity<UnidadeDTO> createUnidade(@RequestBody UnidadeDTO unidadeDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/unidades")
    public ResponseEntity<UnidadeDTO> updateUnidade(@RequestBody UnidadeDTO unidadeDTO) throws URISyntaxException {
