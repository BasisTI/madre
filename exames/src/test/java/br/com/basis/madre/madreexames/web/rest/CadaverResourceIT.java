...
public class CadaverResourceIT {
    ...
    public void createCadaver() throws Exception {
        ...
        assertThat(testCadaver.getCodigoConvenioId()).isEqualTo(DEFAULT_CODIGO_CONVENIO_ID);
    ...
    public void checkCodigoConvenioIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = cadaverRepository.findAll().size();
        // set the field null
        cadaver.setCodigoConvenioId(null);
    ...
    public void updateCadaver() throws Exception {
        ...
        assertThat(testCadaver.getCodigoConvenioId()).isEqualTo(UPDATED_CODIGO_CONVENIO_ID);
