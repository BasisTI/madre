...
public class ItemSolicitacaoExameResourceIT {
     ...
     *
     * @see br.com.basis.madre.madreexames.repository.search.ItemSolicitacaoExameSearchRepositoryMockConfiguration
     */
    @Autowired
    private ItemSolicitacaoExameSearchRepository mockItemSolicitacaoExameSearchRepository;
    ...
    public void createItemSolicitacaoExame() throws Exception {
        ...
        // Validate the ItemSolicitacaoExame in Elasticsearch
        verify(mockItemSolicitacaoExameSearchRepository, times(1)).save(testItemSolicitacaoExame);
    }
    ...
    public void createItemSolicitacaoExameWithExistingId() throws Exception {
        ...
        // Validate the ItemSolicitacaoExame in Elasticsearch
        verify(mockItemSolicitacaoExameSearchRepository, times(0)).save(itemSolicitacaoExame);
    }
    ...
    public void deleteItemSolicitacaoExame() throws Exception {
        ...
        // Validate the ItemSolicitacaoExame in Elasticsearch
        verify(mockItemSolicitacaoExameSearchRepository, times(1)).deleteById(itemSolicitacaoExame.getId());
    }
    ...
    public void searchItemSolicitacaoExame() throws Exception {
        ...
        // Initialize the database
        itemSolicitacaoExameRepository.saveAndFlush(itemSolicitacaoExame);
        when(mockItemSolicitacaoExameSearchRepository.search(queryStringQuery("id:" + itemSolicitacaoExame.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(itemSolicitacaoExame), PageRequest.of(0, 1), 1));
