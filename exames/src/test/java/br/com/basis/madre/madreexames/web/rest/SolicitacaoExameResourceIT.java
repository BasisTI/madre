...
public class SolicitacaoExameResourceIT {
     ...
     *
     * @see br.com.basis.madre.madreexames.repository.search.SolicitacaoExameSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createSolicitacaoExame() throws Exception {
        ...
        // Validate the SolicitacaoExame in Elasticsearch
        verify(mockSolicitacaoExameSearchRepository, times(1)).save(testSolicitacaoExame);
    }
    ...
    public void createSolicitacaoExameWithExistingId() throws Exception {
        ...
        // Validate the SolicitacaoExame in Elasticsearch
        verify(mockSolicitacaoExameSearchRepository, times(0)).save(solicitacaoExame);
    }
    ...
    public void deleteSolicitacaoExame() throws Exception {
        ...
        // Validate the SolicitacaoExame in Elasticsearch
        verify(mockSolicitacaoExameSearchRepository, times(1)).deleteById(solicitacaoExame.getId());
    }
    ...
    public void searchSolicitacaoExame() throws Exception {
        ...
        // Initialize the database
        solicitacaoExameRepository.saveAndFlush(solicitacaoExame);
        when(mockSolicitacaoExameSearchRepository.search(queryStringQuery("id:" + solicitacaoExame.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(solicitacaoExame), PageRequest.of(0, 1), 1));
