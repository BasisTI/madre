...
public class LaboratorioExternoResourceIT {
     ...
     *
     * @see br.com.basis.madre.madreexames.repository.search.LaboratorioExternoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createLaboratorioExterno() throws Exception {
        ...
        verify(mockLaboratorioExternoSearchRepository, times(1)).save(testLaboratorioExterno);
    }
    ...
    public void createLaboratorioExternoWithExistingId() throws Exception {
        ...
        // Validate the LaboratorioExterno in Elasticsearch
        verify(mockLaboratorioExternoSearchRepository, times(0)).save(laboratorioExterno);
    }
    ...
    public void deleteLaboratorioExterno() throws Exception {
        ...
        // Validate the LaboratorioExterno in Elasticsearch
        verify(mockLaboratorioExternoSearchRepository, times(1)).deleteById(laboratorioExterno.getId());
    }
    ...
    public void searchLaboratorioExterno() throws Exception {
        ...
        // Initialize the database
        laboratorioExternoRepository.saveAndFlush(laboratorioExterno);
        when(mockLaboratorioExternoSearchRepository.search(queryStringQuery("id:" + laboratorioExterno.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(laboratorioExterno), PageRequest.of(0, 1), 1));
