...
import br.com.basis.madre.exames.service.ControleQualidadeService;
...
/**
 * REST controller for managing {@link br.com.basis.madre.exames.domain.ControleQualidade}.
 */
@RestController
@RequestMapping("/api")
public class ControleQualidadeResource {
    ...
    public List<ControleQualidadeDTO> getAllControleQualidades() {
        log.debug("REST request to get all ControleQualidades");
        return controleQualidadeService.findAll();
    }
    ...
    public List<ControleQualidadeDTO> searchControleQualidades(@RequestParam String query) {
        log.debug("REST request to search ControleQualidades for query {}", query);
        return controleQualidadeService.search(query);
    }
}
