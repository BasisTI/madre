...
/**
 * REST controller for managing {@link br.com.basis.madre.exames.domain.InformacoesComplementares}.
 */
@RestController
@RequestMapping("/api")
public class InformacoesComplementaresResource {
    ...
    public List<InformacoesComplementaresDTO> getAllInformacoesComplementares() {
        log.debug("REST request to get all InformacoesComplementares");
        return informacoesComplementaresService.findAll();
    }
    ...
    public List<InformacoesComplementaresDTO> searchInformacoesComplementares(@RequestParam String query) {
        log.debug("REST request to search InformacoesComplementares for query {}", query);
        return informacoesComplementaresService.search(query);
    }
}
