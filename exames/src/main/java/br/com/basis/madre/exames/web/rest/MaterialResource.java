...
import br.com.basis.madre.exames.service.MaterialService;
...
/**
 * REST controller for managing {@link br.com.basis.madre.exames.domain.Material}.
 */
@RestController
@RequestMapping("/api")
public class MaterialResource {
    ...
    public List<MaterialDTO> searchMaterials(@RequestParam String query) {
        log.debug("REST request to search Materials for query {}", query);
        return materialService.search(query);
    }
}
