...
public class DiluenteResourceIT {
    ...
    public void setup() {
        ...
        final DiluenteResource diluenteResource = new DiluenteResource(diluenteRepository, mockDiluenteSearchRepository);
    ...
    public void createDiluente() throws Exception {
        ...
        restDiluenteMockMvc.perform(post("/api/diluentes")
            ...
            .content(TestUtil.convertObjectToJsonBytes(diluente)))
    ...
    public void updateDiluente() throws Exception {
        ...
        restDiluenteMockMvc.perform(put("/api/diluentes")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(updatedDiluente)))
            .andExpect(status().isOk());
    ...
    public void searchDiluente() throws Exception {
        // Initialize the database
        diluenteRepository.saveAndFlush(diluente);
        when(mockDiluenteSearchRepository.search(queryStringQuery("id:" + diluente.getId())))
            .thenReturn(Collections.singletonList(diluente));
        // Search the diluente
