...
public class PrescricaoDietaService {
	...
	public PrescricaoDietaDTO save(PrescricaoDietaDTO prescricaoDietaDTO) {
		...
		for (ItemPrescricaoDieta item : prescricaoDieta.getItemPrescricaoDietas()) {
			item.setPrescricaoDieta(prescricaoDieta);
		}
	...
	public Page<PrescricaoDietaDTO> findAll(Pageable pageable) {
		...
		return prescricaoDietaRepository.findAll(pageable).map(prescricaoDietaMapper::toDto);
	}
	...
	public Optional<PrescricaoDietaDTO> findOne(Long id) {
		...
		return prescricaoDietaRepository.findById(id).map(prescricaoDietaMapper::toDto);
	}
