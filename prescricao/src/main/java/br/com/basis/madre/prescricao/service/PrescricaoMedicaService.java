...
public class PrescricaoMedicaService {
	...
	public PrescricaoMedicaService(PrescricaoMedicaRepository prescricaoMedicaRepository,
			PrescricaoMedicaMapper prescricaoMedicaMapper,
			PrescricaoMedicaSearchRepository prescricaoMedicaSearchRepository,
...
//		} 
	...
	public Page<PrescricaoMedicaDTO> findAll(Pageable pageable) {
		...
		return prescricaoMedicaRepository.findAll(pageable).map(prescricaoMedicaMapper::toDto);
	}
	...
	public Optional<PrescricaoMedicaDTO> findOne(Long id) {
		...
		return prescricaoMedicaRepository.findById(id).map(prescricaoMedicaMapper::toDto);
	}
