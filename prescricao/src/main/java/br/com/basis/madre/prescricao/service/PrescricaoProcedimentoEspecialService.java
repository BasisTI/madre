...
public class PrescricaoProcedimentoEspecialService {
	...
	public PrescricaoProcedimentoEspecialService(
			PrescricaoProcedimentoEspecialRepository prescricaoProcedimentoEspecialRepository,
			PrescricaoProcedimentoEspecialMapper prescricaoProcedimentoEspecialMapper,
			PrescricaoProcedimentoEspecialSearchRepository prescricaoProcedimentoEspecialSearchRepository) {
	...
	public PrescricaoProcedimentoEspecialDTO save(PrescricaoProcedimentoEspecialDTO prescricaoProcedimentoEspecialDTO) {
		...
		PrescricaoProcedimentoEspecial prescricaoProcedimentoEspecial = prescricaoProcedimentoEspecialMapper
				.toEntity(prescricaoProcedimentoEspecialDTO);
		for (ItemPrescricaoProcedimentoEspecial item : prescricaoProcedimentoEspecial
				.getItemPrescricaoProcedimentoEspecials()) {
			item.setPrescricaoProcedimentoEspecial(prescricaoProcedimentoEspecial);
		}
		prescricaoProcedimentoEspecial = prescricaoProcedimentoEspecialRepository.save(prescricaoProcedimentoEspecial);
		PrescricaoProcedimentoEspecialDTO result = prescricaoProcedimentoEspecialMapper
				.toDto(prescricaoProcedimentoEspecial);
	...
	public Optional<PrescricaoProcedimentoEspecialDTO> findOne(Long id) {
		...
		return prescricaoProcedimentoEspecialRepository.findById(id).map(prescricaoProcedimentoEspecialMapper::toDto);
	}
