...
public class CadastrosbasicosApp {

    private static final Logger log = LoggerFactory.getLogger(CadastrosbasicosApp.class);

    private final Environment env;

    public CadastrosbasicosApp(Environment env) {
        this.env = env;
    }
