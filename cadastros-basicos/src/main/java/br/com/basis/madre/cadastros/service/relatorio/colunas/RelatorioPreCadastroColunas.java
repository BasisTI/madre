...
public class RelatorioPreCadastroColunas extends  PropriedadesRelatorio {
        ...
        public RelatorioPreCadastroColunas() {
            ...
            super.getColunas().add(new ColunasPropriedadeRelatorio("nomeDaMae", "Nome da Mae", String.class, 10, DynamicExportsConstants.MASCARA_NULL, DynamicExportsConstants.ALINHAR_ESQUERDA));
