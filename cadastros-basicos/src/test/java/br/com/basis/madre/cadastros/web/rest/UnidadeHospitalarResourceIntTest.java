...
public class UnidadeHospitalarResourceIntTest {
    ...
    public void setup() {
        ...
        final UnidadeHospitalarResource unidadeHospitalarResource = new UnidadeHospitalarResource(unidadeHospitalarService, unidadeHospitalarSearchRepository, unidadeHospitalarRepository); this.restUnidadeHospitalarMockMvc = MockMvcBuilders.standaloneSetup(unidadeHospitalarResource)
