...
public class UsuarioResourceIntTest {
   ...
   public void setup() {
       ...
       final UsuarioResource usuarioResource = new UsuarioResource(usuarioRepository,usuarioService, taUsuarioUnidadeHospitalarRepository);
   ...
   public static Usuario createEntity(EntityManager em) {
       Usuario usuario = new Usuario()
           ...
           .ativo(DEFAULT_ATIVO);
       // Add required entity
       Perfil perfil = PerfilResourceIntTest.createEntity(em);
       em.persist(perfil);
       em.flush();
