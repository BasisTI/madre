...
/**
 * Performance test for the Funcionalidade_acao entity.
 */
class Funcionalidade_acaoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Funcionalidade_acao entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all funcionalidade_acaos")
            .get("/cadastrosbasicos/api/funcionalidade-acaos")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
