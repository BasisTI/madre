...
public class CentroDeAtividadeResource {
    ...
    @PostMapping("/centros-de-atividades")
    public ResponseEntity<CentroDeAtividadeDTO> createCentroDeAtividade(@Valid @RequestBody CentroDeAtividadeDTO centroDeAtividadeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/centros-de-atividades/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    @PutMapping("/centros-de-atividades")
    ...
    @GetMapping("/centros-de-atividades")
    ...
    @GetMapping("/centros-de-atividades/{id}")
    ...
    @DeleteMapping("/centros-de-atividades/{id}")
    ...
    @GetMapping("/_search/centros-de-atividades")
