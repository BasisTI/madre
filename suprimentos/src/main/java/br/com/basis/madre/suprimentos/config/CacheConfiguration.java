package br.com.basis.madre.suprimentos.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("suprimentos");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("suprimentos");
        ...
        config.getMapConfigs().put("br.com.basis.madre.suprimentos.domain.*", initializeDomainMapConfig(jHipsterProperties));
