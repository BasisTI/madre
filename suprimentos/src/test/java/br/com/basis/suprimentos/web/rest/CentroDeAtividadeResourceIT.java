...
public class CentroDeAtividadeResourceIT {
    ...
    public static CentroDeAtividade createEntity(EntityManager em) {
        CentroDeAtividade centroDeAtividade = CentroDeAtividade.builder()
            .codigo(DEFAULT_CODIGO)
            .descricao(DEFAULT_DESCRICAO).build();
    ...
    public static CentroDeAtividade createUpdatedEntity(EntityManager em) {
        CentroDeAtividade centroDeAtividade = CentroDeAtividade.builder()
            ...
            .descricao(UPDATED_DESCRICAO).build();
        return centroDeAtividade;
    }
    ...
    public void createCentroDeAtividade() throws Exception {
        ...
        assertThat(testCentroDeAtividade.getCodigo()).isEqualTo(DEFAULT_CODIGO);
    ...
    public void checkCodigoIsRequired() throws Exception {
        ...
        // set the field null
        centroDeAtividade.setCodigo(null);
    ...
    public void updateCentroDeAtividade() throws Exception {
        ...
        updatedCentroDeAtividade.setCodigo(UPDATED_CODIGO);
        updatedCentroDeAtividade.setDescricao(UPDATED_DESCRICAO);
        ...
        CentroDeAtividade testCentroDeAtividade = centroDeAtividadeList.get(centroDeAtividadeList.size() - 1);
        assertThat(testCentroDeAtividade.getCodigo()).isEqualTo(UPDATED_CODIGO);
