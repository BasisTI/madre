...
public class TempoPorClasseResourceIT {
    ...
    private static final TipoTempoPorClasse DEFAULT_TIPO = TipoTempoPorClasse.SALDO;
    private static final TipoTempoPorClasse UPDATED_TIPO = TipoTempoPorClasse.PARCELA;

    private static final Integer DEFAULT_QUANTIDADE_CLASSE_A = 0;
    private static final Integer UPDATED_QUANTIDADE_CLASSE_A = 1;

    private static final Integer DEFAULT_QUANTIDADE_CLASSE_B = 0;
    private static final Integer UPDATED_QUANTIDADE_CLASSE_B = 1;

    private static final Integer DEFAULT_QUANTIDADE_CLASSE_C = 0;
    private static final Integer UPDATED_QUANTIDADE_CLASSE_C = 1;
