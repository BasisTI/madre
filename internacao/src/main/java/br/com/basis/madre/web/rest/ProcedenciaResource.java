...
public class ProcedenciaResource {
    ...
    private static final String ENTITY_NAME = "internacaoProcedencia";
     ...
     * procedenciaDTO, or with status {@code 400 (Bad Request)} if the procedencia has already an
     * ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/procedencias")
    public ResponseEntity<ProcedenciaDTO> createProcedencia(
        @Valid @RequestBody ProcedenciaDTO procedenciaDTO) throws URISyntaxException {
        log.debug("REST request to save Procedencia : {}", procedenciaDTO);
        if (procedenciaDTO.getId() != null) {
            throw new BadRequestAlertException("A new procedencia cannot already have an ID",
     ...
     * procedenciaDTO, or with status {@code 400 (Bad Request)} if the procedenciaDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the procedenciaDTO couldn't be
     * updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/procedencias")
    public ResponseEntity<ProcedenciaDTO> updateProcedencia(
        @Valid @RequestBody ProcedenciaDTO procedenciaDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of procedencias
     * in body.
     */
    @GetMapping("/procedencias")
    public ResponseEntity<List<ProcedenciaDTO>> getAllProcedencias(ProcedenciaDTO procedenciaDTO,
        Pageable pageable) {
        log.debug("REST request to get a page of Procedencias");
        Page<ProcedenciaDTO> page = procedenciaService.findAll(procedenciaDTO, pageable);
     ...
     * procedenciaDTO, or with status {@code 404 (Not Found)}.
     */
    ...
    public ResponseEntity<List<ProcedenciaDTO>> searchProcedencias(@RequestParam String query,
        Pageable pageable) {
