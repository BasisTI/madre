...
public class ConvenioDeSaudeService {
     ...
     *
     * @param convenioDeSaudeDTO
     * @param pageable           the pagination information.
     * @return the list of entities.
     */
    @Transactional(readOnly = true)
    public Page<ConvenioDeSaudeDTO> findAll(
        ConvenioDeSaudeDTO convenioDeSaudeDTO, Pageable pageable) {
        log.debug("Request to get all ConvenioDeSaudes");
        return convenioDeSaudeRepository.findAll(
            Example.of(convenioDeSaudeMapper.toEntity(convenioDeSaudeDTO),
