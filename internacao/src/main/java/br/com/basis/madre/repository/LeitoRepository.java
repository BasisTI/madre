...
public interface LeitoRepository extends JpaRepository<Leito, Long> {
    ...
    @Query("select leito from EventoLeito evento join evento.leito leito where evento.tipoDoEvento.nome = 'Ocupacao' and evento.dataFim is null")
    ...
    @Query("select leito from EventoLeito evento join evento.leito leito\n" +
        ...
        "and current_date between evento.dataInicio and evento.dataFim or evento.tipoDoEvento.nome = 'Ocupacao'")
    Page<Leito> obterTodosOsLeitosNaoLiberados(Pageable pageable);

    @Query("select leito from EventoLeito evento right join evento.leito leito where evento.dataFim > current_date or evento is null")
