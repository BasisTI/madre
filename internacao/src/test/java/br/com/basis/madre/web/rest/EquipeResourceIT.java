...
public class EquipeResourceIT {
    ...
    public void getAllEquipes() throws Exception {
        ...
        restEquipeMockMvc.perform(get("/api/equipes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numeroDoConselho")
                .value(hasItem(DEFAULT_NUMERO_DO_CONSELHO.intValue())))
    ...
    public void searchEquipe() throws Exception {
        // Initialize the database
        equipeRepository.saveAndFlush(equipe);
        when(mockEquipeSearchRepository
            .search(queryStringQuery("id:" + equipe.getId()), PageRequest.of(0, 20)))
