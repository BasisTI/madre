package br.com.basis.madre.consulta.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("consulta");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("consulta");
        ...
        config.getMapConfigs().put("br.com.basis.madre.consulta.domain.*", initializeDomainMapConfig(jHipsterProperties));
