...
import br.com.basis.madre.seguranca.config.KafkaProperties;

@RestController
@RequestMapping("/api/madreseguranca-kafka")
public class MadresegurancaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MadresegurancaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MadresegurancaKafkaResource(KafkaProperties kafkaProperties) {
