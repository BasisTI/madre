...
/**
 * REST controller for managing {@link br.com.basis.madre.seguranca.domain.UF}.
 */
@RestController
@RequestMapping("/api")
public class UFResource {
    ...
    private static final String ENTITY_NAME = "madresegurancaUf";
     ...
     */
    @PostMapping("/ufs")
    public ResponseEntity<UFDTO> createUF(@RequestBody UFDTO uFDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/ufs")
    public ResponseEntity<UFDTO> updateUF(@RequestBody UFDTO uFDTO) throws URISyntaxException {
