...
export class MaterialExamesComponent implements OnInit {
    ...
    adicionarAmostra() {
        ...
        let nomeMaterial = this.materiaisDeAnalise.find(
            (elem) => elem.id == amostra.amostraMaterialId,
        );
        let nomeAnticoagulante = this.anticoagulantes.find(
            (elem) => elem.id == amostra.amostraAnticoagulanteId,
        );
        let nomeRecipiente = this.recipientes.find(
            (elem) => elem.id == amostra.amostraRecipienteId,
        );
    ...
    cadastrarMaterial() {
        ...
        let materialObjeto: MaterialDeAnalise = this.materiaisDeAnalise.find(
            (elem) => (elem.id = materialPreenchido.materialId),
        );
        ...
        let materialDeExames: MaterialDeExames = {
            ...
            tempoPermitidoParaSolicitarPosAlta:
                materialPreenchido.tempoPermitidoParaSolicitarPosAlta,
            tempoPermitidoParaSolicitarPosAltaPelasAreasExecutoras:
                materialPreenchido.tempoPermitidoParaSolicitarPosAltaPelasAreasExecutoras,
