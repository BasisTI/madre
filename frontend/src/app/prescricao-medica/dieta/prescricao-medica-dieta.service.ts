...
export class PrescricaoMedicaDietaService {
    ...
    listarTiposItens(): Observable<Array<TipoItemDieta>> {
        return this.http.get<Array<TipoItemDieta>>(
            `${this.baseUrl}/tipo-item-dietas${this.sortUrl}`,
        );
    }
    ...
    listarTipoUnidade(): Observable<Array<TipoUnidadeDieta>> {
        return this.http.get<Array<TipoUnidadeDieta>>(
            `${this.baseUrl}/tipo-unidade-dietas${this.sortUrl}`,
        );
    }
